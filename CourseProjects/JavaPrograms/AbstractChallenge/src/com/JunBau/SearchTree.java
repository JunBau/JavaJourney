...
public class SearchTree implements NodeList {
    ...
    public boolean addItem(ListItem item) {
        if (this.root == null) {
            // tree was empty, item becomes the first instance of the tree..
            this.root = item;
            return true;
        }

        // if there is an entry, start comparisons.
        ListItem currentItem = this.root;
        while (currentItem != null) {
            int comparison = (currentItem.compareTo(item));
            if (comparison < 0) {
                // the item variable is greater, move right if possible.
                ...
                // the item variable is less, move left is possible
        ...
        // useless return value, but Java compiler requires a return statement outside of this loop.
        return false;
    }
